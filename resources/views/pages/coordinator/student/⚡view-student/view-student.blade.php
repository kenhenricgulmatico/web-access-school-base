...
<div class="max-w-[85rem] px-4 py-8 sm:px-6 lg:px-8 mx-auto space-y-5">
    ...
    <div class="flex items-center justify-between flex-wrap gap-3">
        ...
        <button wire:click="openCreate"
            class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium bg-[#123524] text-white rounded-lg hover:bg-[#0C2418] transition">
    ...
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-4">
            ...
            <p class="text-2xl font-semibold text-gray-800 dark:text-neutral-200">{{ $this->totalCount }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-4">
            <p class="text-xs text-gray-500 dark:text-neutral-400 mb-1">Students</p>
            <p class="text-2xl font-semibold text-purple-700 dark:text-purple-300">{{ $this->studentCount }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-4">
            <p class="text-xs text-gray-500 dark:text-neutral-400 mb-1">Faculty</p>
            <p class="text-2xl font-semibold text-amber-600 dark:text-amber-400">{{ $this->facultyCount }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-4">
            <p class="text-xs text-gray-500 dark:text-neutral-400 mb-1">Pending Approval</p>
            <p class="text-2xl font-semibold text-yellow-600 dark:text-yellow-400">{{ $this->pendingCount }}</p>
        </div>
    ...
    @if($this->pendingCount > 0)
        <div class="p-3 bg-yellow-50 border border-yellow-200 dark:bg-yellow-900/20 dark:border-yellow-800 rounded-lg text-sm text-yellow-700 dark:text-yellow-400 flex items-center gap-2">
            <svg class="w-4 h-4 shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
    ...
    <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-sm overflow-hidden">
        ...
        <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
            <thead class="bg-gray-50 dark:bg-neutral-900/30">
                <tr>
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Name</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Role</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Status</th>
                    <th class="px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Registered</th>
                    <th class="px-5 py-3 text-right text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Actions</th>
                </tr>
            </thead>
            <tbody class="divide-y divide-gray-100 dark:divide-neutral-700">
                @forelse($this->students as $user)
                    <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700/30 transition
                        ...
                        {{-- Registered --}}
                        <td class="px-5 py-3 text-sm text-gray-400 dark:text-neutral-500">
...
<div class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
    <div class="bg-white dark:bg-neutral-800 rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div class="flex justify-end gap-3 px-6 py-4 border-t border-gray-200 dark:border-neutral-700">
            ...
            <button wire:click="create"
                ...
                class="px-4 py-2 text-sm bg-[#123524] hover:bg-[#0C2418] text-white rounded-lg font-medium transition">
