...
<div class="max-w-[85rem] px-4 py-6 sm:py-8 sm:px-6 lg:px-8 mx-auto space-y-5">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between flex-wrap gap-3">
        <div>
            <h2 class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200">Audit Logs</h2>
    ...
    <div class="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        ...
        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-3 sm:p-4">
            <div class="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                <div class="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-blue-600 dark:text-blue-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25Z"/>
                    </svg>
                </div>
                <p class="text-[10px] sm:text-xs text-gray-500 dark:text-neutral-400">Total Logs</p>
            </div>
            <p class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200">{{ $this->totalLogs }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-3 sm:p-4">
            <div class="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                <div class="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-green-100 dark:bg-green-900/30 flex items-center justify-center shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-green-600 dark:text-green-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M6.75 3v2.25M17.25 3v2.25M3 18.75V7.5a2.25 2.25 0 0 1 2.25-2.25h13.5A2.25 2.25 0 0 1 21 7.5v11.25m-18 0A2.25 2.25 0 0 0 5.25 21h13.5A2.25 2.25 0 0 0 21 18.75m-18 0v-7.5A2.25 2.25 0 0 1 5.25 9h13.5A2.25 2.25 0 0 1 21 11.25v7.5"/>
                    </svg>
                </div>
                <p class="text-[10px] sm:text-xs text-gray-500 dark:text-neutral-400">Today</p>
            </div>
            <p class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200">{{ $this->todayLogs }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-3 sm:p-4">
            <div class="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                <div class="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-purple-100 dark:bg-purple-900/30 flex items-center justify-center shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-purple-600 dark:text-purple-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 9V5.25A2.25 2.25 0 0 0 13.5 3h-6a2.25 2.25 0 0 0-2.25 2.25v13.5A2.25 2.25 0 0 0 7.5 21h6a2.25 2.25 0 0 0 2.25-2.25V15M12 9l-3 3m0 0 3 3m-3-3h12.75"/>
                    </svg>
                </div>
                <p class="text-[10px] sm:text-xs text-gray-500 dark:text-neutral-400">Logins today</p>
            </div>
            <p class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200">{{ $this->loginToday }}</p>
        </div>

        <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl p-3 sm:p-4">
            <div class="flex items-center gap-2 sm:gap-3 mb-1 sm:mb-2">
                <div class="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-amber-100 dark:bg-amber-900/30 flex items-center justify-center shrink-0">
                    <svg class="w-3.5 h-3.5 sm:w-4 sm:h-4 text-amber-600 dark:text-amber-400" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M15.75 6a3.75 3.75 0 1 1-7.5 0 3.75 3.75 0 0 1 7.5 0ZM4.501 20.118a7.5 7.5 0 0 1 14.998 0A17.933 17.933 0 0 1 12 21.75c-2.676 0-5.216-.584-7.499-1.632Z"/>
                    </svg>
                </div>
                <p class="text-[10px] sm:text-xs text-gray-500 dark:text-neutral-400">Faculty logs</p>
            </div>
            <p class="text-xl sm:text-2xl font-semibold text-gray-800 dark:text-neutral-200">{{ $this->facultyLogs }}</p>
        </div>
    ...
    <div class="bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-xl shadow-sm overflow-hidden">
        ...
        <div class="px-4 sm:px-5 py-4 border-b border-gray-200 dark:border-neutral-700 flex flex-col sm:flex-row flex-wrap items-start sm:items-center justify-between gap-3">
            <div class="min-w-0">
                ...
                <p class="text-xs text-gray-400 dark:text-neutral-500 mt-0.5 truncate">Logins, logouts, reservations and requests from your department</p>
            </div>
            <div class="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-2 w-full sm:w-auto">
                ...
                <div class="relative w-full sm:w-auto">
                    ...
                    <input type="text" wire:model.live="search"
                        ...
                        class="pl-9 pr-3 py-2 text-sm rounded-lg border border-gray-300 dark:border-neutral-600 dark:bg-neutral-700 dark:text-neutral-200 focus:outline-none focus:ring-2 focus:ring-[#1C6B45] w-full sm:w-48 md:w-52">
                </div>
        ...
        <div class="overflow-x-auto">
            <table class="min-w-[900px] w-full divide-y divide-gray-200 dark:divide-neutral-700">
                <thead class="bg-gray-50 dark:bg-neutral-900/30">
                    <tr>
                        <th class="px-4 sm:px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">User</th>
                        ...
                        <th class="px-4 sm:px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Action</th>
                        <th class="hidden md:table-cell px-4 sm:px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Table</th>
                        <th class="hidden lg:table-cell px-4 sm:px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Details</th>
                        <th class="px-4 sm:px-5 py-3 text-left text-xs font-semibold uppercase tracking-wide text-gray-500 dark:text-neutral-400">Date & Time</th>
                    </tr>
                </thead>
                        ...
                        <tr class="hover:bg-gray-50 dark:hover:bg-neutral-700/30 transition">
                            ...
                            <td class="px-4 sm:px-5 py-3">
                                <div class="flex items-center gap-2 sm:gap-3">
                                    ...
                                    <div class="min-w-0">
                                        ...
                                        <p class="text-xs text-gray-400 dark:text-neutral-500 truncate hidden sm:block">
                                            {{ $log->user->email ?? '—' }}
                                        </p>
                                    </div>
                                </div>
                            ...
                            <td class="px-4 sm:px-5 py-3">
                                <span class="px-2 py-0.5 text-[10px] sm:text-xs font-medium rounded-full inline-flex items-center gap-1 whitespace-nowrap
                                    ...
                                    <span class="hidden xs:inline">{{ ucfirst($log->action) }}</span>
                                    <span class="xs:hidden">{{ substr(ucfirst($log->action), 0, 4) }}</span>
                                </span>
                            </td>

                            {{-- Table (hidden on mobile) --}}
                            <td class="hidden md:table-cell px-4 sm:px-5 py-3 text-sm text-gray-600 dark:text-neutral-400">
                                @php
                                    $tableLabels = [
                                        'sessions'      => 'Session',
                                        'requests'      => 'Request',
                                ...
                                @endphp
                                <code class="text-[10px] sm:text-xs bg-gray-100 dark:bg-neutral-700 px-1.5 py-0.5 rounded whitespace-nowrap">
                                    {{ $tableLabels[$log->table_name] ?? $log->table_name }}
                                </code>
                            </td>

                            {{-- Details (hidden on tablet) --}}
                            <td class="hidden lg:table-cell px-4 sm:px-5 py-3 text-xs text-gray-500 dark:text-neutral-400 max-w-xs">
                                @php
                            ...
                            {{-- Date & Time --}}
                            <td class="px-4 sm:px-5 py-3 text-sm text-gray-500 dark:text-neutral-400 whitespace-nowrap">
                        ...
                        <tr>
                            <td colspan="6" class="px-4 sm:px-5 py-14 text-center">
                                <div class="flex flex-col items-center gap-2">
                                    ...
                                    <p class="text-xs text-gray-400 dark:text-neutral-500 text-center max-w-sm">
