...
lg:block lg:-translate-x-full lg:end-auto lg:bottom-0" role="dialog" tabindex="-1" aria-label="Sidebar">
  ...
  <div class="lg:pt-13 relative flex flex-col h-full max-h-full">
    ...
    {{-- Scrollable nav --}}
    <nav class="p-2.5 sm:p-3 size-full flex flex-col overflow-y-auto overflow-x-hidden [&::-webkit-scrollbar]:w-2 [&::-webkit-scrollbar-thumb]:rounded-none [&::-webkit-scrollbar-track]:bg-gray-50 [&::-webkit-scrollbar-thumb]:bg-gray-300">

      {{-- Mobile header with close button --}}
      <div class="lg:hidden mb-2 flex items-center justify-between">
        <span class="text-xs font-semibold text-gray-700 ps-1">Menu</span>
        <button type="button" class="p-1.5 size-8 sm:size-7.5 inline-flex items-center justify-center gap-x-1 text-xs rounded-md text-gray-500 disabled:opacity-50 disabled:pointer-events-none focus:outline-hidden hover:bg-gray-100" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-pro-sidebar" data-hs-overlay="#hs-pro-sidebar">
      ...
      {{-- Search --}}
      <button type="button" class="p-1.5 ps-2.5 w-full inline-flex items-center gap-x-2 text-sm rounded-lg bg-gray-50 border border-gray-200 text-gray-500 shadow-xs focus:outline-hidden disabled:opacity-50 disabled:pointer-events-none hover:border-[#D4A537]/40 transition" aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-pro-cmsssm" data-hs-overlay="#hs-pro-cmsssm">
        Search
        <span class="ms-auto flex items-center gap-x-1 py-px px-1.5 border border-gray-200 rounded-md shrink-0">
          ...
          <span class="text-[11px] uppercase text-gray-400">k</span>
        </span>
      </button>
        ...
        <ul class="flex flex-col gap-y-1">
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                ...
                focus:outline-hidden focus:bg-gray-200" href="/programHead/dashboard">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.students')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/view-student">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.facility')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/facility">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.material')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/material">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.request-to-admin.*')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/request-to-admin/view-request">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.resource-allocation')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/resource-allocation">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('programHead.notifications')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="/programHead/notifications">
      ...
      <div class="pt-3 mt-3 flex flex-col border-t border-gray-200 first:border-t-0 first:pt-0 first:mt-0">
        ...
        <ul class="flex flex-col gap-y-1">
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('coordinator.profile')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="{{ route('coordinator.profile') }}">
          ...
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm rounded-lg transition min-w-0
                {{ request()->routeIs('coordinator.audit')
                    ? 'bg-[#123524] text-white font-medium shadow-sm'
                    : 'text-gray-700 hover:bg-gray-100' }}
                focus:outline-hidden focus:bg-gray-200" href="{{ route('coordinator.audit') }}">
      ...
      <div class="pt-3 mt-3 lg:hidden flex flex-col border-t border-gray-200 first:border-t-0 first:pt-0 first:mt-0">
        ...
        <ul class="flex flex-col gap-y-1">
          <li>
            <a class="w-full flex items-center gap-x-2.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 focus:outline-hidden focus:bg-gray-200" href="#">
              Docs
            </a>
          </li>
          <li>
    ...
    <footer class="mt-auto p-2.5 sm:p-3 border-t border-gray-200">
      <a href="{{ route('coordinator.profile') }}" class="flex items-center gap-2.5 px-2 py-2 rounded-lg bg-gradient-to-r from-[#123524]/5 to-[#D4A537]/5 min-w-0 hover:from-[#123524]/10 hover:to-[#D4A537]/10 transition">
        ...
        <div class="leading-tight min-w-0">
          <p class="text-[11px] font-semibold text-gray-800 truncate">CSAV Portal</p>
          <p class="text-[10px] text-gray-500 truncate">Program Head</p>
        </div>
      </a>
    </footer>
