            ...
            <ul class="flex flex-row items-center gap-x-2 ms-auto">
                ...
                <li class="inline-flex items-center">
                    <div class="hs-dropdown inline-flex [--strategy:absolute] [--auto-close:inside] [--placement:bottom-right] relative text-start">
                        ...
                        <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 w-60 transition-[opacity,margin] duration opacity-0 hidden z-20 bg-gray-900 border border-dropdown-line rounded-xl shadow-xl"
